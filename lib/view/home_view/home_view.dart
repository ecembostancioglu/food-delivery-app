...
import 'package:food_delivery_app/view/components/menu_list.dart';
                        ...
                        return Padding(
                          ...
                          child: Container(
                                decoration: BoxDecoration(
                                    color: appColors.blurColor.withOpacity(0.1),
                                    borderRadius:
                                        BorderRadius.all(Radius.circular(20.r))),
                                child: Column(
                                  children: [
                                    Image.asset(menuList[index]['image']!,height: 100.h),
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                        Row(children: [
                                          Icon(Icons.location_pin,color: appColors.textColor.withOpacity(0.5)),
                                        Text('Pizza Hut',style: TextStyle(color: appColors.textColor)),],),
                                        Row(children: [
                                          Icon(Icons.star_border,color: appColors.textColor.withOpacity(0.5)),
                                          Text('4.8',style: TextStyle(color: appColors.textColor)),
                                        ],)
